 ...
 * 
 */
@WebServiceClient(name = "AtendeClienteService", targetNamespace = "http://cliente.bean.master.sigep.bsb.correios.com.br/", wsdlLocation = "file:/Users/leobugoni/Projects/simulador/AtendeCliente.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/Users/leobugoni/Projects/simulador/AtendeCliente.wsdl");
